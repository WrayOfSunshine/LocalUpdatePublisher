...
Public Partial Class MainForm
	...
	Private Sub TreeViewSelectServerNode(node As TreeNode)
		...
		If Not ConnectionManager.CurrentServer Is Nothing Then
			...
			_computerNode.ImageIndex = 0
			_computerNode.SelectedImageIndex = 0
	...
	Sub LoadUpdateStatus( rowIndex As Integer)
		...
		Else If TypeOf Me.treeView.SelectedNode.Tag Is IUpdateCategory Then
			...
			Me.dgvUpdateStatus.DataSource = GetUpdateStatus( DirectCast(Me._dgvMain.Rows(rowIndex).Cells("IUpdate").Value, IUpdate), Me._computerNode )
