...
'
' ExportCatalogForm provides an interface to export pacakges to a catalog.
...
Partial Public Class ExportCatalogForm
    ...
    Sub ExportCatalogFormFormClosed(sender As Object, e As FormClosedEventArgs)
        ...
        If Not String.IsNullOrEmpty(m_compactPath) AndAlso Directory.Exists(m_compactPath) Then Directory.Delete(m_compactPath, True)
    ...
    ''' <returns>Boolean indicating if package was successfully added.</returns>
