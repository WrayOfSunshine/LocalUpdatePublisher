...
Public Module EnumExtensions
    ...
    Public Function ToDisplayString(r As RuleTypes) As String
        Select Case r
            Case RuleTypes.WindowsVersion
                Return Globals.globalRM.GetString("rule_windows_version")

            Case RuleTypes.WindowsLanguage
                Return Globals.globalRM.GetString("rule_windows_language")

            Case RuleTypes.ProcessorArchitecture
                Return Globals.globalRM.GetString("rule_processor_architecture")

            Case RuleTypes.FileExists
                Return Globals.globalRM.GetString("rule_file_exists")

            Case RuleTypes.FileExistsWithRegistry
                Return Globals.globalRM.GetString("rule_file_exists_with_registry")

            Case RuleTypes.FileVersion
                Return Globals.globalRM.GetString("rule_file_version")

            Case RuleTypes.FileVersionWithRegistry
                Return Globals.globalRM.GetString("rule_file_version_with_registry")

            Case RuleTypes.FileCreation
                Return Globals.globalRM.GetString("rule_file_creation")

            Case RuleTypes.FileCreationWithRegistry
                Return Globals.globalRM.GetString("rule_file_creation_with_registry")

            Case RuleTypes.FileModified
                Return Globals.globalRM.GetString("rule_file_modified")

            Case RuleTypes.FileModifiedWithRegistry
                Return Globals.globalRM.GetString("rule_file_modified_with_registry")

            Case RuleTypes.FileSize
                Return Globals.globalRM.GetString("rule_file_size")

            Case RuleTypes.FileSizeWithRegistry
                Return Globals.globalRM.GetString("rule_file_size_with_registry")

            Case RuleTypes.RegistryKeyExists
                Return Globals.globalRM.GetString("rule_registry_key_exists")

            Case RuleTypes.RegistryValueExists
                Return Globals.globalRM.GetString("rule_registry_value_exists")

            Case RuleTypes.RegistryDWORDValue
                Return Globals.globalRM.GetString("rule_registry_DWORD_value")

            Case RuleTypes.RegistryExpandSzValue
                Return Globals.globalRM.GetString("rule_registry_expand_SZ_value")

            Case RuleTypes.RegistrySzValue
                Return Globals.globalRM.GetString("rule_registry_SZ_value")

            Case RuleTypes.RegistryVersionInSz
                Return Globals.globalRM.GetString("rule_registry_version_in_SZ")

            Case RuleTypes.WMIQuery
                Return Globals.globalRM.GetString("rule_WMI_query")

            Case RuleTypes.MsiProductInstalled
                Return Globals.globalRM.GetString("rule_MSI_product")

            Case RuleTypes.MsiPatchInstalled
                Return Globals.globalRM.GetString("rule_MSI_patch")

            Case RuleTypes.MsiComponentInstalled
                Return Globals.globalRM.GetString("rule_MSI_component")

            Case RuleTypes.MsiFeatureInstalled
                Return Globals.globalRM.GetString("rule_MSI_feature")
            Case Else
    ...
    Public Function ToDisplayString(a As UpdateApprovalAction) As String
        Select Case a
            Case UpdateApprovalAction.All
                Return Globals.globalRM.GetString("all")
            Case UpdateApprovalAction.Install
                Return Globals.globalRM.GetString("approved_for_install")
            Case UpdateApprovalAction.NotApproved
                Return Globals.globalRM.GetString("not_approved")
            Case UpdateApprovalAction.Uninstall
                Return Globals.globalRM.GetString("uninstall")
            Case Else
                Return ""
        End Select
    End Function
    ...
    Public Function GetSortedEnum(ByVal enumType As Type) As ArrayList
        ...
        If enumType.BaseType.FullName = "System.Enum" Then
            ...
            Return tmpArray
        Else
            Throw New ArgumentException(Globals.globalRM.GetString("error_sort_enumerator"), "t")
            Return Nothing
        End If
    End Function
